...
```{r echo=FALSE, fig.height=4, fig.width= 10,fig.cap="Figure1.Data was separated by 'Content.Rating' column in order to  show the relationship between the number of reviews and installs more clearly. Different colors represented for different categories."}
...
```{r echo=FALSE, fig.height=4, fig.width=10, fig.cap="Figure2. The relationship between size and the number of reviews."}
...
```{r echo=FALSE, fig.height=4, fig.width=10, fig.cap="Figure3.The relationship between rating and the number of reviews." }
...
```{r echo=FALSE, fig.cap="Plot of most popular category by number of reviews"}
data.clean %>%
...
```{r echo=FALSE, fig.cap="Distribution of application size(in MB)"}
data.clean %>%
  count(Size)  %>%
...
```{r echo=FALSE, fig.cap="Application size range (in MB) by application type"}
...
```{r echo=FALSE, fig.cap="Percentage of paid vs free apps"}
...
```{r echo=FALSE, fig.cap="Percentage of Free vs Paid by Category"}
data.clean %>%
